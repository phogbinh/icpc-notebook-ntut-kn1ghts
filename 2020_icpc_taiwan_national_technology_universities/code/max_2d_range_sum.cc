// This is a solution for UVa 108 - Maximum Sum. In this problem, we are given a
// square matrix of integers and are asked to find a sub-matrix with the maximum
// sum. This 1D DP + greedy (Kadane's) solution takes time O(n^3).
